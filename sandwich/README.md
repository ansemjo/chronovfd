...
![](render/vfddriver_pcb.png "vfddriver PCB layout")
![](render/vfddriver_render_front.png "vfddriver PCB render, front")
![](render/vfddriver_render_back.png "vfddriver PCB render, back")

![](photos/vfddriver00.jpg "First batch of PCBs from Aisler.net")
![](photos/vfddriver01.jpg "An assembled VFD driver board")
![](photos/vfddriver02.jpg "Testing a board on a breadboard with an Arduino")
...
![](render/clockcore_pcb.png "clockcore PCB layout")
![](render/clockcore_render_front.png "clockcore PCB render, front")
![](render/clockcore_render_back.png "clockcore PCB render, back")

![](photos/clockcore00.jpg "A soldered clockcore circuit boards in small helping hands grips.")
![](photos/clockcore01.jpg "An assembled chronovfd, where both boards are screwed together with standoffs.")
![](photos/fullon.jpg "Testing the display by lighting up all segments to their full brightness.")
