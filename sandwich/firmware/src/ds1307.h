 ...
 * Compatible with DS1338 real-time clock.
 *
 ...
 *
 * BSD Licensed as described in the file LICENSE in
 * https://github.com/UncleRus/esp-idf-lib/blob/master/components/ds1307/LICENSE
 */
#ifndef __DS1307_H__
#define __DS1307_H__
